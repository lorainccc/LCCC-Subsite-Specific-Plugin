...
function lc_show_dept_contact_info_meta_box( $object, $box ) { ?>
 ...
 <?php wp_nonce_field( basename( __FILE__ ), 'lc_dept_contact_post_nonce' ); ?>
  ...
  <p>
   ...
   <input type="text" name="lc_social_media_facebook_field" id="lc_social_media_facebook_field" value="<?php echo esc_attr( get_post_meta ( $object->ID, 'lc_social_media_facebook_field', true ) ); ?>" size="40" />
  </p>
  ...
  <p>
   ...
   <input type="text" name="lc_social_media_twitter_field" id="lc_social_media_twitter_field" value="<?php echo esc_attr( get_post_meta ( $object->ID, 'lc_social_media_twitter_field', true ) ); ?>" size="40" />
  </p>
